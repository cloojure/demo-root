...
var args4498 = [];
var len__3290__auto___4501 = arguments.length;
var i__3291__auto___4502 = (0);
while(true){
if((i__3291__auto___4502 < len__3290__auto___4501)){
args4498.push((arguments[i__3291__auto___4502]));

var G__4503 = (i__3291__auto___4502 + (1));
i__3291__auto___4502 = G__4503;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args4498.length)].join('')));
...
return (function (){
if(cljs.core.truth_((function (){var and__2771__auto__ = clojure.browser.repl.load_queue;
if(cljs.core.truth_(and__2771__auto__)){
return cljs.core.deref.call(null,loaded) === false;
} else {
return and__2771__auto__;
}
})())){
...
var script__$1 = (function (){var G__4508 = script;
goog.object.set(G__4508,"type","text/javascript");

goog.object.set(G__4508,"onload",onload);

goog.object.set(G__4508,"onreadystatechange",onload);

return G__4508;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__4509 = script__$1;
goog.object.set(G__4509,"src",src);

return G__4509;
})():(function (){var G__4510 = script__$1;
goog.dom.setTextContext(G__4510,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__2779__auto__ = reload;
...
var path_4511 = (goog.dependencies_.nameToPath[src]);
goog.object.remove(goog.dependencies_.visited,path_4511);

goog.object.remove(goog.dependencies_.written,path_4511);

goog.object.remove(goog.dependencies_.written,[cljs.core.str(goog.basePath),cljs.core.str(path_4511)].join(''));
} else {
}
